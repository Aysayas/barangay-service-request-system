...
<section class="workflow-page">
    <div class="workflow-header">
        <div>
            <p class="workflow-kicker">Admin Complaint Review</p>
    ...
    <div class="mt-6 grid gap-6 lg:grid-cols-[1fr_0.9fr]">
        ...
        <div class="space-y-6">
            <section class="workflow-card">
                <h2 class="text-lg font-semibold text-slate-950">Processing Summary</h2>
                <dl class="mt-4 space-y-4 text-sm">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-slate-600"><?= e(complaint_priority_label($complaint['priority'])); ?></dd>
                    </div>
                    <div>
                        <dt class="font-medium text-slate-800">Updated</dt>
                        <dd class="mt-1 text-slate-600"><?= e(date('M d, Y h:i A', strtotime($complaint['updated_at']))); ?></dd>
                    </div>
                </dl>
                ...
                <div class="mt-5">
                    ...
                    <?php if (!empty($complaint['staff_notes'])): ?>
                        <p class="mt-2 whitespace-pre-line text-sm leading-6 text-slate-700"><?= e($complaint['staff_notes']); ?></p>
                    <?php else: ?>
                ...
                <div class="mt-5">
                    <h3 class="text-sm font-medium text-slate-800">Resolution Notes</h3>
                    <?php if (!empty($complaint['resolution_notes'])): ?>
                        <p class="mt-2 whitespace-pre-line text-sm leading-6 text-slate-700"><?= e($complaint['resolution_notes']); ?></p>
                    <?php else: ?>
                        <p class="mt-2 text-sm text-slate-600">No resolution notes yet.</p>
                    <?php endif; ?>
                </div>
            </section>
