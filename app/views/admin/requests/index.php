...
<?php $base_url = site_url('admin/requests'); ?>

<section>
    <div class="flex flex-wrap items-start justify-between gap-4">
        <div>
            <p class="text-sm font-semibold uppercase tracking-normal text-teal-700">Admin Review</p>
            <h1 class="mt-2 text-3xl font-bold text-zinc-950">Requests</h1>
            <p class="mt-3 max-w-2xl text-zinc-700">
                Open a request to review payment status or upload its final generated document.
            </p>
        </div>
