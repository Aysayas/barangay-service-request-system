...
<body>
    <div class="page">
        ...
        <div class="section">
            ...
            <table class="metric">
                <tr><th>Total Complaints</th><td><?= e($summary['total_complaints']); ?></td></tr>
                <tr><th>Open Complaints</th><td><?= e($summary['open_count']); ?></td></tr>
                ...
                <tr><th>In Progress</th><td><?= e($summary['investigating_count']); ?></td></tr>
                <tr><th>Resolved</th><td><?= e($summary['resolved_count']); ?></td></tr>
                <tr><th>Closed</th><td><?= e($summary['closed_count']); ?></td></tr>
                <tr><th>Dismissed</th><td><?= e($summary['dismissed_count']); ?></td></tr>
                <tr><th>Most Common Category</th><td><?= !empty($summary['most_common_category']) ? e(complaint_category_label($summary['most_common_category'])) : 'None yet'; ?> (<?= e($summary['most_common_category_total']); ?> complaint(s))</td></tr>
            </table>
        </div>

        <div class="section">
            <h2>Complaint Rows</h2>
            <?php if (empty($rows)): ?>
                <p class="muted">No complaint records match the selected report filters.</p>
            <?php else: ?>
                <table class="rows">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php foreach ($rows as $row): ?>
                            <tr>
                                ...
                                <td><?= e($row['complainant_name']); ?></td>
                                <td><?= e($row['subject']); ?></td>
                                <td><?= e(complaint_category_label($row['category'])); ?></td>
                                <td><span class="badge"><?= e(complaint_priority_label($row['priority'])); ?></span></td>
                                <td><span class="badge"><?= e(complaint_status_display_label($row['status'])); ?></span></td>
                                <td><?= !empty($row['assigned_to_name']) ? e($row['assigned_to_name']) : 'Unassigned'; ?></td>
