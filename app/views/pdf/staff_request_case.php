...
if (!empty($final_document) && !empty($final_document_exists)) {
    $final_document_status = final_document_download_allowed($request['status'])
        ? 'Ready for Download'
        : 'Uploaded, Waiting for Release';
...
<head>
    <meta charset="utf-8">
    <title><?= e($case_scope ?? 'Request Case'); ?> <?= e($request['reference_no']); ?></title>
    <style>
    ...
    <div class="page">
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><?= e($request['last_processed_by_name'] ?: 'Not processed yet'); ?></td>
                </tr>
            </table>
        </div>
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    <th>Email</th>
                    <td><?= e($request['resident_email']); ?></td>
                </tr>
                <tr>
                    <th>Contact Number</th>
                    <td><?= e($request['resident_contact_number'] ?: 'Not provided'); ?></td>
                </tr>
                <tr>
                    <th>Address</th>
                    <td><?= e($request['resident_address'] ?: 'Not provided'); ?></td>
                </tr>
            </table>
        </div>
        ...
        <?php if ((int) $request['requires_payment'] === 1): ?>
            <div class="section">
                ...
                <table>
                    ...
                    <tr>
                        <th>Reviewed By</th>
                        <td><?= e($payment['verified_by_name'] ?? 'Not reviewed yet'); ?></td>
                    </tr>
                    <tr>
                        <th>Remarks</th>
                        <td><?= e($payment['remarks'] ?? 'No remarks recorded.'); ?></td>
                    </tr>
                </table>
            </div>
        <?php endif; ?>
        ...
        <div class="section">
            ...
            <?php if (!empty($request['staff_notes'])): ?>
                <div class="text-block"><?= e($request['staff_notes']); ?></div>
            <?php else: ?>
                <p class="muted">No staff notes have been recorded.</p>
            <?php endif; ?>
        </div>
            ...
            <?php else: ?>
                <ul>
                    <?php foreach ($audit_logs as $log): ?>
                        <li><?= e(date('M d, Y h:i A', strtotime($log['created_at']))); ?> - <?= e($log['description']); ?></li>
                    <?php endforeach; ?>
                </ul>
            <?php endif; ?>
        </div>
        ...
        <div class="footer">
            This PDF is a generated operational case summary. Use the online request record for the latest workflow status, payment proof files, and final document download.
        </div>
    </div>
</body>
</html>
